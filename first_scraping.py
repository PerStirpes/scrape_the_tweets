...
# with open('tweets_local_results.csv', 'w', newline='') as outfile:
...
#     sauce = urlopen("file:///Users/booboo/Rithm/scrape_the_tweets/index_tweets_wapo.html").read()
...
with open('tweets_local_results.tsv', 'w', newline='') as outfile:
    writer = csv.writer(outfile)
    writer.writerow(['date','time','tweets'])
